...
app.controller('CreateTradeCtrl', function ($http, $location, $uibModalInstance, $uibModal, demoApp, apiBaseURL, peers, $loadingOverlay) {
    ...
    modalInstance.create = () => {
        ...
        if (invalidFormInput()) {
            ...
            const createTradeEndpoint = `${apiBaseURL}create-trade?counterParty=${modalInstance.form.counterparty}&sellValue=${modalInstance.form.sellValue}&longContract=${modalInstance.form.longContract}&sellCurrency=${modalInstance.form.sellCurrency}&tradeStatus=PENDING`;
